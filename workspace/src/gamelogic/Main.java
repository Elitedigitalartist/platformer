...
public class Main extends GameBase implements PlayerDieListener, PlayerWinListener, ScreenTransitionListener{
	...
	public void init() {
		...
		try {
			levels[0] = LeveldataLoader.loadLeveldata("/workspaces/platformer/workspace/maps/start.txt");
			levels[1] = LeveldataLoader.loadLeveldata("/workspaces/platformer/workspace/maps/frog.txt");
		} catch (Exception e) {
			e.printStackTrace();
		}
